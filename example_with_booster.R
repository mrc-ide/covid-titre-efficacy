...
# parameters
mu_ab_list <- data.frame(name = c("Example vaccine product"),
                         mu_ab_d1 = c(20/59),
                         mu_ab_d2 = c(32/59),
                         mu_ab_d3 = c(32*4/59))
...
draw <- function(mu_ab_d1 = mu_ab_d1, mu_ab_d2 = mu_ab_d2, mu_ab_d3, std10 = std10, ab_50 = ab_50, ab_50_severe, dr_s = dr_s, dr_l = dr_l, t = t, t_d2 = t_d2, t_d3, k = k, time_to_decay = time_to_decay){
...
for (j in 1:1){
  ...
  r1 <- NULL
  for (i in 1:100){
    out <- draw(mu_ab_d1 = mu_ab_d1, mu_ab_d2 = mu_ab_d2, mu_ab_d3 = mu_ab_d3, std10 = std10, ab_50 = ab_50, ab_50_severe, dr_s = dr_s, dr_l = dr_l, t = t, t_d2 = t_d2, t_d3, k = k, time_to_decay = time_to_decay)
...
plotout <- (plots[[1]] | plots[[2]] | plots[[3]])
plotout
ggsave("Fig_3dose_example.png", plotout, height = 4, width = 15)
